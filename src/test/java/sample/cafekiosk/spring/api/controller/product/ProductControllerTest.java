...
@WebMvcTest(controllers = ProductController.class) // 컨트롤러 관련 빈들만 띄움, 서비스(Service), 리포지토리(Repository) 빈들은 기본적으로 로드되지 않음
class ProductControllerTest {
    ...
    @Autowired
    private ObjectMapper objectMapper; // JSON과 Object간의 직렬화, 역직렬화를 도와줌
